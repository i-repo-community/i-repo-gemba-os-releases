...
2. [画面の使い方](manual-screens.html) — 各画面の操作（概要・フロー作成・データ確認・スケジュール・現場 AI チャット など全12画面）
3. [常駐（システムトレイ）](manual-tray.html) — 閉じても裏で動かす
4. [着信 Webhook の詳細](manual-webhook.html) — 外部システムからフローを起動する
5. [AI 連携の詳細](manual-ai.html) — Claude / Codex などのエージェント連携
6. [トラブルシューティング](manual-troubleshooting.html) — 困ったときに
7. [用語集](manual-glossary.html) — 用語の補足
